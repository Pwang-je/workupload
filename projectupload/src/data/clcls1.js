export const clcls1 = {
  ...
  "questions": {
    ...
    "54": [
      {
        "question": "모든 실수$$x$$에서 정의된 함수$$f(x) = \\arccos (\\cos x)$$에 대하여$$f(x + \\pi)$$를 구하면? <br> (단,$$\\arccos 1 = 0$$)",
        "choices": [
          "$$\\pi - f(x)$$",
          "$$\\pi - x$$",
          "$$\\pi + f(x)$$",
    ...
    "57": [
      ...
      {
        "question": "$$\\sin \\alpha = -\\frac{4}{5} \\left( \\pi < \\alpha < \\frac{3}{2} \\pi \\right)$$일 때,$$\\tan \\frac{\\alpha}{2}$$의 값을 구하면?",
        "choices": [
          "$$-2$$",
          "$$-\\frac{4}{3}$$",
          "$$-\\frac{3}{4}$$",
    ...
    {
      "question": "함수$$f(x) = \\sinh x$$에 대하여$$f(a) = \\frac{12}{5}$$일 때,$$f'(a)$$의 값은?",
      "choices": [
        "$$-\\frac{5}{12}$$",
        "$$\\frac{5}{12}$$",
        "$$-\\frac{13}{5}$$",
    ...
    "96": [
      {
        "question": "이차곡선$$x^2 - xy + y^2 = 12$$위의 점 중에서 접선의 기울기가$$0$$인 점의 좌표를 모두 고르면?",
        "choices": [
          "$$(-4, -2), (2, -4)$$",
          "$$(-4, -2), (4, 2)$$",
          "$$(-2, -4), (-4, -2)$$",
    ...
    "100": [
      ...
      {
        "question": "함수$$f(x) = \\arctan (\\arcsin \\sqrt{x})$$에 대하여$$f' \\left( \\frac{1}{4} \\right) = \\frac{a}{b + \\pi^2} \\cdot \\frac{1}{\\sqrt{3}}$$일 때,$$a + b$$의 값은?<br> (단,$$a, b$$는 정수이다.)",
        "choices": [
          "$$84$$",
          "$$96$$",
          "$$108$$",
    ...
    "113": [
      {
        "question": "미분가능한 함수$$f$$가$$-\\frac{\\pi}{2} < x < \\frac{\\pi}{2}$$일 때,$$f(\\sin x) = x^2 + 1$$을 만족한다.<br>$$x = \\frac{1}{2}$$에서 접선의 기울기는?",
        "choices": [
          "$$\\frac{2 \\sqrt{3} \\pi}{9}$$",
          "$$-\\frac{\\sqrt{3} \\pi}{9}$$",
          "$$0$$",
    ...
    "118": [
      ...
      {
        "question": "곡선$$e^{\\frac{x}{y}} = x - y$$위의 점$$(0, a)$$에서 접선이 직선$$y = x + 3$$과 점$$(b, c)$$에서 만날 때,$$a + b + c$$의 값은?",
        "choices": [
          "$$5$$",
          "$$10$$",
          "$$20$$",
    ...
    "140": [
    {
      "question": "임의의 자연수$$n$$에 대하여 두 함수$$f(x)$$와$$g(x)$$는$$n$$번 미분 가능하다. 두 함수의 곱$$fg$$의 4계 도함수가 다음과 같을 때$$\\sum_{r=0}^4 a_r$$의 값을 구하면?",
    ...
    {
      "question": "7번 미분 가능한 임의의 두 함수$$f, g : \\mathbb{R} \\to \\mathbb{R}$$에 대하여$$(fg)^{(7)} = f^{(7)}g + a_6 f^{(6)}g^{(1)} + a_5 f^{(5)}g^{(2)} + \\cdots + a_1 f^{(1)}g^{(6)} + f g^{(7)}$$으로 나타낼 때, 상수$$a_1, a_2, ..., a_6$$의 평균은?",
      "choices": [
        "$$20$$",
        "$$21$$",
        "$$24$$",
    ...
    {
      "question": "구간$$I$$에서 무한 번 미분 가능한 두 함수$$f$$와$$g$$의 곱$$fg$$의 10계 도함수를 다음과 같이 쓸 때,$$a_0 + a_2 + a_4 + a_6 + a_8 + a_{10}$$의 값은?",
