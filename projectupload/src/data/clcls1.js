export const clcls1 = {
  ...
  questions: {
    ...
    74: [
      ...
      {
        question:
          "$$f(x) = (x^2 + x + 1)(x^2 - x + 1)$$일 때,$$x = 1$$에서 미분계수는?",
        choices: [],
        answer: "",
      },
      {
      ...
      {
        question:
          "$$f(2) = -1, f'(2) = 4, g(2) = 1$$그리고$$g'(2) = -5$$이다.$$P(x) = \\frac{f(x)}{g(x)}$$일 때,$$F'(2)$$의 값은?",
        choices: [],
        answer: "",
      },
      {
    ...
    78: [
      ...
      {
        question:
          "$$f(x) = 2x + \\ln x$$일 때,$$\\left(f^{-1}(2)\\right)'$$의 값은?",
        choices: [],
        answer: "",
      },
      {
    ...
    87: [
      ...
      {
        question:
          "곡선$$x^y + x - y = 2$$위의 점 중에서 접선의 기울기가$$-1$$인 점이$$(a, b)$$라 할 때,$$ab$$의 값은?",
        choices: ["$$0$$", "$$1$$", "$$2$$", "$$4$$"],
        answer: "",
      },
      {
    ...
    91: [
      ...
      {
        question:
          "함수$$f(x) = \\cosh 2x$$에 대하여$$f'(\\ln 2)$$의 값을 구하면?",
        choices: [
          "$$-\\frac{3}{4}$$",
          "$$-\\frac{1}{4}$$",
          "$$0$$",
    ...
    98: [
      ...
      {
        question:
          "함수$$f(x) = x\\sqrt{3 + x^2}$$에 대하여 역함수의 미분계수$$\\left(f^{-1}\\right)'(-2)$$의 값은?",
        choices: [
          "$$\\frac{1}{5}$$",
          "$$\\frac{2}{5}$$",
          "$$\\frac{3}{5}$$",
      ...
      {
        question:
          "함수$$f(x) = \\frac{1}{\\sqrt{x^2 + x + 1}}$$에 대하여$$f'(-1)$$의 값은?",
        choices: [
          "$$-\\frac{1}{3}$$",
          "$$-\\frac{1}{2}$$",
          "$$\\frac{1}{2}$$",
    ...
    108: [
      ...
      {
        question:
          "곡선$$y = x^{x^{\\csc x}}$$위의 점$$\\left( \\frac{\\pi}{2}, \\frac{\\pi}{2} \\right)$$에서의 접선의 방정식을$$y = f(x)$$라 할 때,$$f(1)$$의 값은?",
        choices: ["$$1$$", "$$2$$", "$$3$$", "$$4$$"],
        answer: "",
      },
      {
    ...
    114: [
      ...
      {
        question:
          "평면 위의 한 점$$P(4,3)$$에서 중심이 원점이고 반지름이 1인 원에 그은 두 접선과 원과의 접점을 각각$$A$$와$$B$$라고 하자. 이 때,$$PA \\cdot PB$$의 값은?",
    ...
    117: [
      {
        question:
          "두 곡선$$y^3 = x^3$$과$$\\frac{x^2}{a^2} + \\frac{y^2}{b^2} = 1$$의 1 사분면 위 교점을$$(x_0, y_0)$$라 하자. 점$$(x_0, y_0)$$에서의 두 곡선에 대한 접선이 서로 수직일 때$$a$$와$$b$$의 관계식을 옳은 것은?",
        choices: [
          "$$3a^2 = 2b^2$$",
          "$$2a^2 = 3b^2$$",
          "$$a^2 = b^3$$",
    ...
    127: [
      ...
      {
        question:
          "매개변수 곡선$$\\begin{cases} x = \\theta - \\sin \\theta \\\\ y = 1 - \\cos \\theta \\end{cases}$$에 대해$$\\frac{d^2y}{dx^2}$$를 구하시오.",
        choices: [],
        answer: "",
      },
      {
        question:
          "매개변수 곡선$$\\begin{cases} x = t^2 \\\\ y = t^3 - 2t \\end{cases}$$에 대해$$\\frac{d^2y}{dx^2}$$를 구하시오.",
        choices: [],
        answer: "",
      },
      {
    ...
    130: [
      {
        question:
          "함수$$f$$가 일대일 대응이고 두 번 미분 가능한 함수라 하자.$$f$$의 역함수를$$g$$라 할 때,$$g'(x) = \\alpha \\frac{f'(g(x))}{[f(g(x))]^\\beta}$$가 성립한다. 이 때$$\\alpha + \\beta$$의 값은?",
        choices: ["$$0$$", "$$1$$", "$$2$$", "$$3$$", "$$4$$"],
        answer: "",
      },
      {
