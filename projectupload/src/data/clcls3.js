...
"36": [
  ...
  },
  {
    ...
    "example": "$$(a) \\ x \\cos x \\leq \\sin x \\\\\n(b) \\ \\sin x \\leq \\frac{\\sqrt{2}}{2}\\left(\\frac{x}{\\frac{\\pi}{4}} + 1\\right) \\\\\n(c) \\ \\cos x \\leq \\frac{\\pi}{2} - x$$",
    "choices": [
      "$$(a), (b)$$",
      "$$(a), (c)$$",
      "$$(b), (c)$$",
...
"88": [
  ...
  "100": [
    {
      "question": "실수 전체에서 정의된 미분가능 함수 $$f(x)$$가 아래 표에 나타낸 값을 가진다.\\\\\\n\\n$$\n\\begin{array}{|c|c|c|c|c|c|}\n\\hline\nx & -2 & -1 & 0 & 1 & 2 \\\\\n\\hline\nf(x) & -8.5 & -1 & -0.5 & 0.25 & 2.5 \\\\\n\\hline\nf'(x) & 12 & 3 & 0 & 0.5 & 2 \\\\\n\\hline\n\\end{array}\n$$\\n\\n함수 $$g(x) = \\sqrt{x^3 - 3f(x)}$$의 $$x = 1$$에서의 일차근사함수를 이용하여 $$g(1.1)$$의 근삿값을 구하면?",
      "choices": [
        "$$0.65$$",
        "$$0.68$$",
        "$$0.7$$",
  ...
  "101": [
    ...
    },
    {
      ...
      "example": "$$\\begin{aligned}\n&\\text{가. } f \\text{는 } x = 0 \\text{에서 연속이다.} \\\\\n&\\text{나. } f \\text{는 } x = 0 \\text{에서 미분가능이다.} \\\\\n&\\text{다. } f \\text{는 } x = 0 \\text{에서 Taylor 급수 전개 가능하다.}\n\\end{aligned}$$",
      "choices": [
        "$$\\text{없다.}$$",
        "$$\\text{가}$$",
        "$$\\text{가, 나}$$",
  ...
  "103": [
    {
      "question": "$$|x| < \\frac{1}{2}$$인 모든 실수 $$x$$에 대하여 $$\\frac{1}{1 + x + x^2} = \\sum_{n=0}^{\\infty} a_n x^n$$라 하자. $$a_0 + a_3$$의 값을 구하여라. (단, $$a_n$$은 상수이다.)",
      "choices": [
        "$$1$$",
        "$$2$$",
        "$$3$$",
...
"135": [
  ...
  },
  {
    ...
    "choices": [
      ...
      "$$\\text{모든 } n에 대하여 \\sum_{k=1}^{n} |a_k| \\leq M \\text{인 양수 } M \\text{이 존재한다.}$$",
      "$$|a_1| > |a_2| > \\cdots \\text{이고, } \\lim_{n \\to \\infty} |a_n| = 0$$"
    ],
    "answer": ""
  },
  {
...
"136": [
  ...
  },
  {
    ...
    "example": "$$\\begin{aligned}\n&\\text{ㄱ. } \\sum_{n=0}^{\\infty} (-1)^n a_n \\\\\n&\\text{ㄴ. } \\sum_{n=0}^{\\infty} a_n \\\\\n&\\text{ㄷ. } \\sum_{n=0}^{\\infty} \\sin(a_n)\n\\end{aligned}$$",
    "choices": [
      "$$\\text{ㄱ, ㄴ}$$",
      "$$\\text{ㄱ, ㄷ}$$",
      "$$\\text{ㄴ, ㄷ}$$",
  ...
  },
  {
    ...
    "choices": [
      "$$\\text{수렴한다.}$$",
      "$$\\text{조건부 수렴한다.}$$",
      "$$\\text{근사값이 } \\frac{5}{6} \\text{이면 최대오차의 절대값은 } \\frac{1}{4} \\text{이다.}$$",
      "$$\\text{근사값이 } \\frac{7}{12} \\text{이면 최대오차의 절대값은 } 0.2 \\text{이상이다.}$$"
    ],
    "answer": ""
  }
],
"137": [
  ...
  },
  {
    ...
    "example": "$$\\begin{aligned}\n&\\text{(가)}\\ \\lim_{n \\to \\infty} a_n = 0 \\text{이면 급수 } \\sum a_n \\text{는 수렴한다.} \\\\\n&\\text{(나)}\\ \\text{급수 } \\sum a_n \\text{이 발산하면 급수 } \\sum |a_n| \\text{도 발산한다.} \\\\\n&\\text{(다)}\\ \\text{급수 } \\sum c_n 6^n \\text{이 수렴하면 급수 } \\sum c_n (-2)^n \\text{도 수렴한다.} \\\\\n&\\text{(라)}\\ \\sum_{n=0}^{\\infty} \\frac{(-1)^n}{n!} = \\frac{1}{e}\n\\end{aligned}$$",
    "choices": [
      "$$\\text{1개}$$",
      "$$\\text{2개}$$",
      "$$\\text{3개}$$",
  ...
  },
  {
    ...
    "example": "$$\\begin{aligned}\n&\\text{(가)}\\ \\sum_{n=0}^{\\infty} (-3)^n a_n \\text{은 발산한다.} \\\\\n&\\text{(나)}\\ \\sum_{n=0}^{\\infty} a_n \\text{은 수렴한다.} \\\\\n&\\text{(다)}\\ \\sum_{n=0}^{\\infty} 5^n a_n \\text{은 발산한다.}\n\\end{aligned}$$",
    "choices": [
      "$$\\text{가, 나}$$",
      "$$\\text{나, 다}$$",
      "$$\\text{가, 다}$$",
...
"141": [
  ...
  },
  {
    ...
    "choices": [
      "$$\\text{모든 } n\\text{에 대해 } a_n \\leq b_n \\text{이고 } \\sum_{n=1}^{\\infty} b_n \\text{이 수렴하면 } \\sum_{n=1}^{\\infty} a_n \\text{은 수렴한다.}$$",
      "$$\\text{모든 } n\\text{에 대해 } b_n \\leq a_n \\text{이고 } \\sum_{n=1}^{\\infty} b_n \\text{이 수렴하면 } \\sum_{n=1}^{\\infty} a_n \\text{은 수렴한다.}$$",
      "$$\\text{모든 } n\\text{에 대해 } b_n \\leq a_n \\text{이고 } \\sum_{n=1}^{\\infty} b_n \\text{이 수렴하면 } \\sum_{n=1}^{\\infty} a_n \\text{은 발산한다.}$$",
      "$$\\text{모든 } n\\text{에 대해 } |b_n| \\leq a_n \\text{이고 } \\sum_{n=1}^{\\infty} b_n \\text{이 수렴하면 } \\sum_{n=1}^{\\infty} a_n \\text{은 수렴한다.}$$",
      "$$\\text{모든 } n\\text{에 대해 } |b_n| \\leq a_n \\text{이고 } \\sum_{n=1}^{\\infty} b_n \\text{이 발산하면 } \\sum_{n=1}^{\\infty} a_n \\text{은 발산한다.}$$"
    ],
    "answer": ""
  }
],
